...
function MyPage() {
  ...
  if (!isLoggedIn) {
    return (
      <div className="relative flex min-h-full flex-col items-center justify-center overflow-hidden bg-[var(--bg-page-soft)] px-6 py-[100px]">
  ...
  return (
    <div className="relative min-h-full overflow-hidden bg-[var(--bg-page-soft)]">
