...
describe("LineupCarousel", () => {
  it("라인업 카드는 레퍼런스형 비율(320/360)과 peeking 배치를 사용한다", () => {
    ...
    expect(markup).toContain("aspect-ratio:320/360");
    expect(markup).toContain("width:86%");
    expect(markup).toContain("transform:translateX(calc(7% - 1 * (86% + 12px)))");
  });
